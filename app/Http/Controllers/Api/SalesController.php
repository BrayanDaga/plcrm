...
class SalesController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('p.id as payment_id','p.amount','p.user_id as client','u.name as client_name','u.last_name as client_last_name','c.title as course','c.user_id','cp.price','cp.desc','a.account as client_account','u.photo')
